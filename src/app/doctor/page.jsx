...
import { createPrescription, getPatientsOfDoctor, getPrescriptionsByDoctor, getRole } from '@/context/prescriptionServices'
...
const DoctorPage = () => {
    ...
    const addMedication = () => {
        setNewPrescription(prev => ({
            ...prev,
            medications: [...prev.medications, { drugId: '', dosage: '', no_days: '' }]
        }))
    }
                ...
                <TabsContent value="create">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Fill in the details to create a new prescription</CardDescription>
                        </CardHeader>
                        <CardContent>
                                ...
                                <div className="grid gap-4">
                                    ...
                                    <div className="grid gap-2">
                                        ...
                                        <Input
                                            ...
                                            onChange={(e) => setNewPrescription(prev => ({ ...prev, recommendedPharmacy: e.target.value }))}
                                            placeholder="0x..."
                                        />
                                    </div>
                                    <div className="grid gap-2">
                                        ...
                                        <Input
                                            ...
                                            onChange={(e) => setNewPrescription(prev => ({ ...prev, detailsHash: e.target.value }))}
                                            placeholder="0x..."
                                        />
                                    </div>
                                </div>
                                        ...
                                        <div key={index} className="grid gap-4 md:grid-cols-3">
                                            ...
                                            <div className="grid gap-2">
                                                ...
                                                <Input
                                                    type="number"
                                                    value={med.no_days}
                                                    onChange={(e) => updateMedication(index, 'no_days', e.target.value)}
                                                    placeholder="Days"
                                                />
                                            </div>
                                        </div>
                ...
                <TabsContent value="prescriptions">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>List of all prescriptions you've created</CardDescription>
                        </CardHeader>
                        <CardContent>
                                    ...
                                    <TableBody>
                                        {prescriptions.map((prescription, index) => (
                                            <TableRow key={index}>
                                                ...
                                                <TableCell className="font-mono">{prescription.patient}</TableCell>
                                                <TableCell className="font-mono">{prescription.recommendedPharmacy}</TableCell>
                                                <TableCell>
                                                    {prescription.ordered ? "Ordered" : prescription.accepted ? "Accepted" : "Pending"}
                                                </TableCell>
                                            </TableRow>
                                        ))}
                                    </TableBody>
